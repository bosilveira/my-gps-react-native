...
export default function DisclaimerPage({ navigation }: Props) {
    ...
    <ScrollView style={{marginVertical: 8, marginHorizontal: 16, backgroundColor: 'rgba(245, 245, 245, 1)'}}>
        { language === 'pt-BR' && <View>
            <Text variant="titleLarge" style={{textAlign: 'center'}}>Aviso</Text>
            ...
            <Divider style={{marginVertical: 8}} />
            <Text variant="labelLarge" style={{textAlign: 'center'}}>My GPS &copy; Todos os direitos reservados.</Text>
            <Divider style={{marginVertical: 8}} />
        </View> }
        ...
        { language === 'en-US' && <View>
            ...
            <Text variant='labelLarge' style={{textAlign: 'center'}}>(2) LGPD, https://www.gov.br/cidadania/pt-br/acesso-a-informacao/lgpd</Text>
            <Divider style={{marginVertical: 8}} />
            <Text variant="labelLarge" style={{textAlign: 'center'}}>My GPS &copy; All rights reserved.</Text>
            <Divider style={{marginVertical: 8}} />
        </View>}
        ...
        { language === 'es-ES' && <View>
            ...
            <Text variant='labelLarge' style={{textAlign: 'center'}}>(2) LGPD, https://www.gov.br/cidadania/pt-br/acesso-a-informacao/lgpd</Text>
            <Divider style={{marginVertical: 8}} />
            <Text variant="labelLarge" style={{textAlign: 'center'}}>My GPS &copy; Todos los derechos reservados.</Text>
            <Divider style={{marginVertical: 8}} />
        </View>}
